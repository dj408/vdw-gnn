...
show_help() {
    ...
    echo ""
    echo "Example:"
    echo "  sbatch $0 --config=qm9/escgnn.yaml --dataset=QM9 --subsample_n=1024 --conda_env=myenv"
    echo ""
...
# source /bsuhome/davejohnson408/scratch/escgnn/.venv/bin/activate
