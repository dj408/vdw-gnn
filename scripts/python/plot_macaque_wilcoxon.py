#!/usr/bin/env python3
"""
Generate and save a plot of multi-day, multi-model macaque experiment results, annotated
with Wilcoxon test significance markers.
"""
...
MODEL_ORDER = ["escgnn_1", "marble", "cebra", "lfads_1"]
MODEL_PLOT_NAMES = {
    "escgnn_1": "VDW-GNN",
    "marble": "MARBLE",
    "cebra": "CEBRA",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--results_dir", type=str, default="escgnn/results/macaque", help="Results directory")
