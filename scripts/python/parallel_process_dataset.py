...
python3 "/bsuhome/davejohnson408/scratch/escgnn/code/scripts/python/parallel_process_dataset.py" \
--dataset_key QM9 \
--dataset_dir "/bsuhome/davejohnson408/scratch/escgnn/data/QM9" \
--h5_path "/bsuhome/davejohnson408/scratch/escgnn/data/QM9/pq_tensor_data_radial.h5" \
...
--dataset_key QM9 \
--dataset_dir "/bsuhome/davejohnson408/scratch/escgnn/data/QM9" \
--h5_path "/bsuhome/davejohnson408/scratch/escgnn/data/QM9/pq_tensor_data_chem.h5" \
--hdf5_tensor_dtype float16 \
--num_workers 48 \
