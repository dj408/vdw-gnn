...
the same sampling/seed conventions as the ESCGNN experiments, and 
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Base random seed (matches ESCGNN runs).",
    )
    parser.add_argument(
        "--epochs",
        type=int,
...
def seed_rng(base_seed: int, combo_idx: int, rep_idx: int) -> np.random.RandomState:
    """
    Match the ESCGNN seeding strategy for consistent sampling/splits.
    """
