...
def train_model(
    ...
    for epoch in range(epoch_ctr.n + 1, last_ctr_epoch + 1):
        ...
        # ESCGNN:Reset per-epoch scatter debug counters on the real model, if available
        # try:
        ...
        # --------------------------------------------------------------
        # ESCGNN [Only needed when caching scatter tensors in epoch 1, not when precomputing on data loading]: after finishing epoch 1, prefill scatter caches for all
        ...
        # --------------------------------------------------------------
        # ESCGNN: Once-per-epoch: print scattering cache stats if model provides them
