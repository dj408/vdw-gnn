...
class ModelConfig:
    ...
    #  - 'escgnn':  Spectral Operator-based graph scattering network  
    #  - 'escgnn_radial':  Bessel RBF version of ESCGNN with gated message passing
    ...
    # ------------------------------------------------------------------
    # Newer ESCGNN model architecture parameters (line, molecule)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # ScatterMLP / escgnn_layer parameters
    # ------------------------------------------------------------------
    ...
    # ESCGNN_macaque: whether to use vector invariants (norms, cosines) or preserve vectors
    ...
    # ESCGNN_macaque: whether to use per-trajectory path graphs (legacy mode)
    scatter_path_graphs: bool = True
    
    # ESCGNN_macaque graph aggregation mode (for graph-level tasks with invariants)
    ...
    # ESCGNN_macaque_supcon-specific configuration
    ...
    # Learnable Mahalanobis top-k (ESCGNN SupCon v2)
