"""
Simplified inductive ESCGNN variant for macaque reaching with SupCon loss.
...
class ESCGNN_macaque_supcon_2(BaseModule):
    """
    ...
    def _prepare_batch(self, batch: Batch | Data) -> Data:
        ...
        if self.learnable_P:
            ...
            raise ValueError(
                "ESc-GNN SupCon v2 model requires 'Q' diffusion operator attached to the Batch."
            )
        return data
